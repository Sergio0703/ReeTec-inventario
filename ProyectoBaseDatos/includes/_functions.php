...
function insertar_productos(){
    ...
    $consulta="INSERT INTO productos (NombreLibro, Autor, añoLanzamiento, FisicoVirtual, categorias, imagen)
    VALUES ('$NombreLibro', '$Autor', '$añoLanzamiento', '$FisicoVirtual', '$categorias' , '$imagenFin');" ;
...
function editar_producto(){
    ...
    $consulta="UPDATE productos SET NombreLibro = '$NombreLibro', Autor = '$Autor', añoLanzamiento = '$añoLanzamiento', FisicoVirtual = '$FisicoVirtual', categorias = '$categorias', imagen = '$imagenFin' WHERE id = $id";
