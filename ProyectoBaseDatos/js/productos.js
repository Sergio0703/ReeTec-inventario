 ...
 if(respuesta){
    ...
    $.post('../../includes/_functions.php', obj, function(response){
       ...
       response.map(function(i){
           ...
           html += `    <tr> 
                        <td class="${datosTabla.Categoria}">${datosTabla.id}</td>
                        <td>${datosTabla.NombreLibro}</td>
                        <td>${datosTabla.Autor}</td>
                        <td>${datosTabla.añoLanzamiento}</td>
                        <td>${datosTabla.FisicoVirtual}$</td>
...
const confirmacion = confirm('¿Desea editar el libro?')
...
$('#table-data').on('click', '.eliminar', function(e){
   ...
   const confirmacion = confirm('¿Desea eliminar el libro?')
